...
signal left_controller_button_pressed
signal left_controller_button_release
signal right_controller_button_pressed
signal right_controller_button_release
...
func _on_LeftHandController_button_pressed(button):
	emit_signal("left_controller_button_pressed", button)
	pass


func _on_LeftHandController_button_release(button):
	emit_signal("left_controller_button_release", button)
	pass


func _on_RightHandController_button_pressed(button):
	emit_signal("right_controller_button_pressed", button)
	pass


func _on_RightHandController_button_release(button):
	emit_signal("right_controller_button_release", button)
	pass
